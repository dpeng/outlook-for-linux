...
| `followSystemTheme` | `boolean` | `false` | Follow the operating-system dark/light theme preference. Default is false; set true to drive Outlook's theme from the OS preference. | `restart` |
