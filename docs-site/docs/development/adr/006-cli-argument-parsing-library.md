...
1. Add CLI-based action commands (`outlook-for-linux action toggle-mute`)
...
- Handle meeting URLs as positional arguments (`outlook-for-linux https://teams.cloud.microsoft/...`)
