...
class HomeAssistantDiscovery {
	...
	async publishDiscovery() {
		const entities = [
			...
			{
				component: 'binary_sensor',
				objectId: 'meeting_started',
				config: this.#buildBinarySensorConfig('Outlook Meeting Started', 'meeting_started', this.#mediaTopics.meetingStarted, 'mdi:calendar-clock')
			},
			{
				component: 'button',
