...
// corner, where it does not cover Outlook's global search and account controls.
// Exported for the e2e bounds assertions.
const SWITCHER_PILL_SIZE = 56;

// When the pill's dropdown is open the view grows to cover the full content
// area so its scrim catches outside clicks and the dropdown is not clipped.
